...
public class PlanBar extends View {
    ...
    private void init(Context context) {
        ...
        insidePaint.setColor(getResources().getColor(R.color.colorPrimary));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(positionX / 3, positionY / 3, getMeasuredWidth() / 3 * 2 + positionX / 3
                , getMeasuredHeight() / 2 + positionY / 3, outPaint);
        canvas.drawCircle(getMeasuredWidth() / 3 * 2 + positionX / 3, getMeasuredHeight() / 4 + positionY / 3
                , getMeasuredHeight() / 4, outPaint);

        canvas.drawLine(positionX / 3, getMeasuredHeight() / 4 + positionY / 3, 45 + progess
                , getMeasuredHeight() / 4 + positionY / 3, insidePaint);
